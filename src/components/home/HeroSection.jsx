        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="relative w-full aspect-square max-w-[24rem] lg:max-w-none lg:w-[38rem] lg:h-[38rem] z-20 pointer-events-none flex justify-center items-center"
            >
              <img
                src="/hero.png"
                alt="Premium Standalone Array"
                className="w-full h-auto max-h-[120%] object-contain scale-110 drop-shadow-[0_30px_60px_rgba(34,197,94,0.4)]"
              />
